...
//        lesson.lessonType = [lessonFieldsArray objectAtIndex:7];
    ...
    [homeView setTitle:@"Bé học tiếng Anh"];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"Edu4Kids" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"Edu4Kids.sqlite"];
